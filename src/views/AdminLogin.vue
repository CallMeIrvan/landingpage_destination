...
const handleLogin = async () => {
  ...
  try {
    ...
    const user = await loginAdmin(loginForm.value.email, loginForm.value.password)

    // Simpan informasi user ke localStorage untuk referensi
    ...
    switch (error.code) {
      case 'auth/user-not-found':
        errorMessage.value = 'Email admin tidak ditemukan'
        break
      ...
      case 'auth/too-many-requests':
        errorMessage.value = 'Terlalu banyak percobaan login. Coba lagi nanti'
        break
      case 'auth/operation-not-allowed':
        errorMessage.value = 'Email/Password authentication tidak diaktifkan'
        break
      default:
        ...
        } else if (error.message.includes('akses admin')) {
          errorMessage.value = 'User tidak memiliki akses admin'
        } else {
